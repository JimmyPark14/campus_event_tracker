                        ...
                        ...liveEvents.take(3).map((event) {
                          return Padding(
                            ...
                            child: _buildMyEventCard(context,
                              ...
                              badge: event.isDraft ? 'Draft' : (event.availableSpots <= 0 ? 'Sold Out' : 'Live'),
                              badgeColor: event.isDraft ? Theme.of(context).colorScheme.surfaceContainerHigh : (event.availableSpots <= 0 ? Theme.of(context).colorScheme.errorContainer : Theme.of(context).colorScheme.secondaryContainer),
                              onBadgeColor: event.isDraft ? Theme.of(context).colorScheme.onSurfaceVariant : (event.availableSpots <= 0 ? Theme.of(context).colorScheme.error : Theme.of(context).colorScheme.secondary),
                              hasImage: true,
