...
class StudentProfileSettings extends StatelessWidget {
  const StudentProfileSettings({super.key});
                    ...
                    children: [
                      Expanded(
                        child: GestureDetector(
                          onTap: () {
                            final following = userProfile?.following ?? [];
                            UserListSheet.show(
                              context,
                              title: 'Following',
                              userIds: following,
                      ...
                      Expanded(
                        child: Column(
                          children: [
                            Text(
                              ((userProfile?.points ?? 0) ~/ 10).toString(),
            ...
            _buildSettingsGroup(
              ...
              items: [
                _SettingsItem(
                  ...
                  subtitle: 'Update personal info & email',
                ...
                _SettingsItem(
                  ...
                  route: '/settings/student-billing',
                ),
                _SettingsItem(
