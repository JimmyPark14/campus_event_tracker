...
class StudentNotificationPreferences extends StatefulWidget {
  const StudentNotificationPreferences({super.key});

  @override
  State<StudentNotificationPreferences> createState() => _StudentNotificationPreferencesState();
}

class _StudentNotificationPreferencesState extends State<StudentNotificationPreferences> {
  ...
  void initState() {
    ...
    _prefs = {
      ...
      'Waitlist Alerts': userPrefs['Waitlist Alerts'] ?? true,
      'New Events from Organizers': userPrefs['New Events from Organizers'] ?? false,
    };
  }
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _buildSwitchTile('Waitlist Alerts', 'When a spot opens up'),
          const SizedBox(height: 12),
          _buildSwitchTile('New Events from Organizers', 'From subscribed organizers'),
                ...
                if (uid != null) {
                  await FirebaseFirestore.instance.collection('users').doc(uid).set({
                    'preferences': {
                      ...
                      'Waitlist Alerts': _prefs['Waitlist Alerts'],
                      'New Events from Organizers': _prefs['New Events from Organizers'],
                    }
