...
class OrganizerPrivacySecurity extends StatefulWidget {
  const OrganizerPrivacySecurity({super.key});

  @override
  State<OrganizerPrivacySecurity> createState() => _OrganizerPrivacySecurityState();
}

class _OrganizerPrivacySecurityState extends State<OrganizerPrivacySecurity> {
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              const Text('Please type "DELETE" below to confirm you understand that all your events and data will be permanently removed.'),
              const SizedBox(height: 16),
              TextField(
